  ...
  return (
    <div className="h-full bg-white p-8 flex flex-col justify-between">
      ...
      <div>
        ...
        {/* Typography section */}
        <div className="mb-8">
          <p className="text-sm text-gray-600 mb-1">Typography selection: <span className="font-medium">Britti Sans</span>,</p>
        ...
        <div className="mb-8">
          <div className="flex items-start gap-2 mb-2">
            ...
            <h2 className="text-lg font-medium text-gray-900">Why?</h2>
          </div>
          <p className="text-gray-700 mb-2 font-medium">You've got a great product.</p>
          <p className="text-gray-700">Let's make sure your visuals match.</p>
        </div>
        ...
        <div className="mb-8">
          <div className="flex items-start gap-2 mb-4">
            ...
            <h3 className="text-lg font-medium text-gray-900">What you will get?</h3>
          </div>
      ...
      <div>
        ...
        <div className="mb-6">
          <div className="flex items-baseline gap-2 mb-2">
            ...
            <span className="text-lg text-gray-500 line-through">$1279</span>
          </div>
          <p className="text-sm text-gray-600 mb-1">No calls. No fluff. Straight to your inbox.</p>
          <p className="text-sm text-gray-600 mb-4">2 spots available.</p>
        </div>
        ...
        <div className="mb-6">
          <div className="flex items-start gap-2 mb-2">
            ...
            <span className="text-sm font-medium text-gray-900">5-7 days delivery time</span>
          </div>
        ...
        {/* CTA Button */}
        <button className="bg-black text-white px-6 py-3 rounded-lg text-sm font-medium hover:bg-gray-800 transition-colors w-full">
